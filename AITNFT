...
contract AITONFT is UniversalONFT721 {
    constructor(uint256 _minGasToStore, address _layerZeroEndpoint, uint _startMintId, uint _endMintId) UniversalONFT721("AITONFT Protocol", "AITONFT", _minGasToStore, _layerZeroEndpoint, _startMintId, _endMintId) {}
}
